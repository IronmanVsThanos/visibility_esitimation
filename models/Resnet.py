...
import torch
from high_low_dai import LearnableFilters
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.in_channel = 64
        self.LearnableFilters = LearnableFilters(512, 7, 7)
        self.groups = groups
    ...
    def forward(self, x1):
        ...
        # print(x2.shape)
        # print(x2)
        # x_t = Histogram_tensor(x2)
        # x_t = feature_Extra.feature_extra(x1)
        x = self.conv1(x1)
        x = self.bn1(x)
        x = self.relu(x)
